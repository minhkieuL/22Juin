 ...
 */
  ...
  //parametres de connexion
    ...
    String urlconnexionjdbc="jdbc:mysql://localhost:3306/mariage";
    String utilisateurjdbc="mk";
    String motdepassejdbc="mpmk";
    ...
    public void contextInitialized(ServletContextEvent event)
    {
        ...
        try
        {
            ...
            connection = DriverManager.getConnection (urlconnexionjdbc,"mk","mpmk");
